...
export default async function AboutPage({ params }: PageProps<"/[lang]/about">) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <SectionHeading eyebrow={dict.nav.about} title={dict.about.title} subtitle={dict.about.subtitle} as="h1" />
      ...
      <div className="mt-20 grid gap-10 lg:grid-cols-2">
        <div className="surface h-full rounded-[var(--radius-card)] p-8">
          ...
          <ul className="mt-6 space-y-4">
            {values.map((v) => (
              <li key={v} className="flex items-center gap-3">
                <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-teal-700">
